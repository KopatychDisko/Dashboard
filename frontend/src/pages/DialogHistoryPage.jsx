        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="glass-card p-3 sm:p-4 lg:p-6">
              ...
              {/* Список пользователей */}
              <div className="space-y-1.5 sm:space-y-2 max-h-[400px] sm:max-h-[500px] lg:max-h-[600px] overflow-y-auto">
                      ...
                      {hasMoreMessages && (
                        <div className="flex justify-center mt-4 pt-4 border-t border-white/10">
                          <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-white/10 rounded-lg transition-colors text-white/70 text-sm font-medium disabled:opacity-50"
                          >
                            {loadingDialog ? (
                              <>
